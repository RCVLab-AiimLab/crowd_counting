...
# GENERAL
parser.add_argument('--model_desc', default='shanghaiB, 128, 7, trial21/', help="Set model description")
...
parser.add_argument('--momentum', default=0.9325, type=float, help="momentum")
