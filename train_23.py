...
# GENERAL
parser.add_argument('--model_desc', default='shanghaiB, 128, 7, trial23/', help="Set model description")
...
parser.add_argument('--momentum', default=0.936, type=float, help="momentum")
