...
import pathlib
from model_11 import ComputeLoss, CSRNet
from dataset_6 import listDataset
...
# GENERAL
parser.add_argument('--model_desc', default='train_11/', help="Set model description")
parser.add_argument('--pre_model_desc', default='train_11_pre/', help="Set model description")
