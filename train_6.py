...
# GENERAL
parser.add_argument('--model_desc', default='shanghaiB, 128, 7, trial6/', help="Set model description")
...
parser.add_argument('--log_dir', default=path.parent/'/home/16amf8/data/work_dirs/crowd_counting_shanghai_b/logs', type=str, help='log dir')
