...
# GENERAL
parser.add_argument('--model_desc', default='shanghaiA, 128, 7, trial25/', help="Set model description")
...
parser.add_argument('--momentum', default=0.93, type=float, help="momentum")
