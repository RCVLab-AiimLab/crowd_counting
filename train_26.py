...
# GENERAL
parser.add_argument('--model_desc', default='shanghaiA, 128, 7, trial26/', help="Set model description")
...
parser.add_argument('--checkpoint_path', default=path.parent/'/home/16amf8/data/work_dirs/crowd_counting_shanghai_a', type=str, help='checkpoint path')
parser.add_argument('--log_dir', default=path.parent/'/home/16amf8/data/work_dirs/crowd_counting_shanghai_a/log', type=str, help='log dir')
...
parser.add_argument('--momentum', default=0.925, type=float, help="momentum")
