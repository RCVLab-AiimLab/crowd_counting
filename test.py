...
parser.add_argument('--model_desc', default='shanghaiA, trial38/', help="Set model description")
...
parser.add_argument('--checkpoint_path', default='/home/16amf8/data/work_dirs', type=str, help='checkpoint path')
parser.add_argument('--log_dir', default='/home/16amf8/data/work_dirs/log', type=str, help='log dir')
