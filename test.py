...
parser.add_argument('--vis_loc', default=True, type=bool, help='visualize the locations') 
                ...
                for j in range(nj):  
                    ...
                    if i == (ni-1) and j == (nj-1):
                        ...
                        with torch.no_grad():
                            ...
                            if args.vis_image:
                                vis_image(args, img_name, img_big, imgs, target_chips, ni, nj, predictions0, predictions1, predictions2, vis_loc=False)

                            if args.vis_loc:
                                vis_image(args, img_name, img_big, imgs, target_chips, ni, nj, predictions0, predictions1, predictions2, vis_loc=True)
...
def vis_image(args, img_name, img_big, imgs, target_chips, ni, nj, predictions0, predictions1, predictions2=None, vis_loc=False):
