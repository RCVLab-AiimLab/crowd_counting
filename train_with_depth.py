...
parser.add_argument('--val_json', default=os.path.join(path,'datasets/shanghai/part_A_val.json'), help='path to test json')
...
def train(args, model, optimizer, train_list, val_list, train_list_depth, val_list_depth, tb_writer, CUDA):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train_depth_loader = torch.utils.data.DataLoader(listDataset(train_list_depth,
        #                shuffle=False,
        #                depth=True,
        ...
        # pbar_depth = enumerate(train_depth_loader)
        ...
        for bi, (img_big, target_big, img_big_depth) in pbar:  # batch ----------
            ...
            # print('depth',img_big.shape)
            # print('depth',img_big_depth.shape)
            ...
            for i in range(ni):  
                for j in range(nj):  
                    ...
                    img = Variable(img)
                    # img_depth = Variable(img_chip_depth)
                    imgs.append(img)
...
def main():
    ...
    if args.exp == 'shanghai':
        ...
        train_list = [st.replace('/home/leeyh/Downloads/Shanghai/part_A_final/train_data/images', 'crowdcounting_main/datasets/shanghai/part_A_final/train_data/images') for st in train_list_fab]
        val_list = [st.replace('/home/leeyh/Downloads/Shanghai/part_A_final/train_data/images', 'crowdcounting_main/datasets/shanghai/part_A_final/train_data/images') for st in val_list_fab]
        
        train_list_depth = [st.replace('/home/leeyh/Downloads/Shanghai/part_A_final/train_data/images', 'crowdcounting_main/datasets/shanghai/part_A_final/train_data/depth_resized') for st in train_list_fab]
        val_list_depth = [st.replace('/home/leeyh/Downloads/Shanghai/part_A_final/train_data/images', 'crowdcounting_main/datasets/shanghai/part_A_final/train_data/depth_resized') for st in val_list_fab]
        # print(train_list_depth[100])
