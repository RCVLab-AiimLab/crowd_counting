...
# GENERAL
parser.add_argument('--model_desc', default='shanghaiA, 128, 7, trial24/', help="Set model description")
...
parser.add_argument('--momentum', default=0.935, type=float, help="momentum")
