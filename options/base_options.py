...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--gpu_ids', type=str, default='4,5,6,7', help='gpu ids: e.g. 0  0,1,2, 0,2')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='crowdcounting_main/checkpoints/', help='models are saved here')
