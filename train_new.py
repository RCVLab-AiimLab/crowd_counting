...
def train(args, model, optimizer, train_list, val_list, train_list_depth, val_list_depth, tb_writer, CUDA, num_imgs_train, num_imgs_val):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        pbar = tqdm(pbar, total=len(train_loader), position=0, leave=True)  # progress bar
        ...
        imgs, targets = [], []
        # print('before')
        for bi, (img, bxy, l, depth) in pbar:  # batch ----------
...
def main():
    ...
    if args.exp == 'shanghai':
        ...
        for i, cat in enumerate(catgrs):
            ...
            # print(direct[i])
        # direct[0] = direct[0][0:12]
        # direct[1] = direct[1][0:20]
    ...
    train(args, model, optimizer, train_list, val_list, train_list_depth, val_list_depth, tb_writer, CUDA, num_imgs_train, num_imgs_val) 
