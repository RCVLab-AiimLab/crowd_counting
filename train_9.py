...
import pathlib
from model_9 import ComputeLoss, CSRNet
...
# GENERAL
parser.add_argument('--model_desc', default='train_9/', help="Set model description")
            ...
            for i in range(ni):  
                for j in range(nj):  
                    ...
                    if i == (ni-1) and j == (nj-1):
                        ...
                        with torch.no_grad():
                            predictions0, predictions1, predictions2, count = model(imgs, imgs_depth, training=False)
...
def main():
    ...
    args.pre_checkpoint_path = os.path.join(args.pre_checkpoint_path,'checkpoint.pth.tar')
