...
import pathlib
from model_14 import ComputeLoss, CSRNet
...
# GENERAL
parser.add_argument('--model_desc', default='train_14/', help="Set model description")
...
parser.add_argument('--device', default='4', type=str, help='GPU id to use.')
