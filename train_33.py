...
import pathlib
from model_33 import ComputeLoss, CSRNet
...
# GENERAL
parser.add_argument('--model_desc', default='train_33', help="Set model description")
parser.add_argument('--pre_model_desc', default='train_7', help="Set model description")
